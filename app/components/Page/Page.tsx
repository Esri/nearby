...
import { on, whenTrueOnce } from "esri/core/watchUtils";
...
class Page extends Widget {
  ...
  @property()
  @messageBundle("nearby/app/components/Page/t9n/resources")
  messages = null;
  ...
  postInitialize() {
    ...
    on(this.portal, "credential", "token-change", () => {
      this.handleBackgroundImgToken();
    });
  }
  ...
  handleBackgroundImgToken(): void {
    ...
    if (
      ...
      background.backgroundImage.url.indexOf(
        "resources/media/instantAppsConfigPanel"
      ) !== -1
    ) {
